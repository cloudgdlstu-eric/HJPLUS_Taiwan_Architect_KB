...
- **2026-08-12** 🚒 新增各類場所消防安全設備設置檢討技能與互動式配置檢算網頁（輸入建築基本參數，一鍵生成法規應設消防設備清單與決策路徑）
- **2026-08-12** 🚒 新增灑水與泡沫滅火系統配管檢討技能（自動撒水與泡沫配管管徑及噴頭數量檢討，含管徑對照表與泡沫放射分區）
...
- **2026-08-07** 🏷️ 清理 B 類分類債：8 個台灣本土法規／標章技能由 B 改為 C，10 個國際規範技能補上台灣適配 TODO 標記（B 18→10、C 53→61）
...
| **C 類台灣法規技能** | 66 個 | 完全台灣法規，MCP 工具對接 | 台灣法規本位，官方對接 |
